 ...
 *   /cpu_hog [seconds]
 *
 * Burns CPU in a tight loop and prints progress once per second.
 * Compare completion times between containers with different nice values
 * to observe CFS priority effects.
 *
